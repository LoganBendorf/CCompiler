...
static void short_vec_4_double_expand(short_vec_4_double* self) {
    const size_t heap_capacity = get_heap_capacity(self);
    if (heap_capacity == 0) {
        short_vec_4_double_reserve(self, INLINE_CAP + 2);
    } else {
        short_vec_4_double_reserve(self, INLINE_CAP + heap_capacity * 2);
    }
}

void short_vec_4_double_insert(void* void_self, const size_t index, const double value) {
    short_vec_4_double* self = (short_vec_4_double*) void_self;
...
void short_vec_4_double_push_back(void* void_self, const double value) {
    short_vec_4_double* self = (short_vec_4_double*) void_self;
    ...
    if (index < INLINE_CAP) {
        ...
        if (heap_index >= heap_capacity) {
            short_vec_4_double_expand(self);
        }
...
double short_vec_4_double_index(void* void_self, const size_t index) {
    short_vec_4_double* self = (short_vec_4_double*) void_self;
...
void short_vec_4_double_destroy(void* void_self) {
    ...
    double* heap_array = self->heap_array;
